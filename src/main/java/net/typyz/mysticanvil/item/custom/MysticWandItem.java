package net.typyz.mysticanvil.item.custom;
...
import static net.typyz.mysticanvil.block.ModBlocks.MYSTIC_LOG;

public class MysticWandItem extends Item {
    public MysticWandItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    private boolean isMysticLogBlock(BlockState state) {
        return state.getBlock() == MYSTIC_LOG.get();
    }
