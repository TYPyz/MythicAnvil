...
public class RitualRecipeSerializer implements RecipeSerializer<RitualRecipe> {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, RitualRecipe> STREAM_CODEC =
        StreamCodec.composite(
            // Target block - use ByteBufCodecs.fromCodec for BlockState
            ByteBufCodecs.fromCodec(BlockState.CODEC),
            RitualRecipe::getTargetBlock,
            // Trigger item
            Ingredient.CONTENTS_STREAM_CODEC,
            RitualRecipe::getTriggerItem,
            // Thrown items
            Ingredient.CONTENTS_STREAM_CODEC.apply(ByteBufCodecs.list()),
            RitualRecipe::getThrownItems,
            // Result
            ItemStack.STREAM_CODEC,
            RitualRecipe::getResult,
            // Consume trigger
            ByteBufCodecs.BOOL,
            RitualRecipe::shouldConsumeTrigger,
            // Lightning
            ByteBufCodecs.BOOL,
            RitualRecipe::shouldStrikeLightning,
            RitualRecipe::new
        );
